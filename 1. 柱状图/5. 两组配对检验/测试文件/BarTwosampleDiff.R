...
paired <- args[8]
#####命令行#####
#/opt/biosoft/anaconda3/envs/R_4.3.0/bin/Rscript /opt/onems/Rshell/BarTwosampleDiff.R /root/panpan/barplot/ttest1.eg.xls  /root/panpan/barplot/ttest3.eg.xls /root/panpan/barplot/ttest2.eg.xls "t_test" "pvalue" 1 0.05 T
