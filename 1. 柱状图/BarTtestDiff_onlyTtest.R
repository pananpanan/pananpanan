...
#library(plyr)
#需要传入的参数
#datafile<-"E:/panpan/1. 柱状图/data/ttest1.eg.xlsx"
...
#####命令行#####
#BarDiff(datafile,sampleinfosfile,groupsfile,log2fc,pvalue)



BarDiff <- function(datafile,sampleinfosfile,groupsfile,log2fc,pvalue){
  ...
  ########数据准备########
  Data_Prepration <- function(data,sampleinfos,groups,log2fc,pvalue){
  ...
  Data_Pr<-Data_Prepration(Data,Sampleinfos,Groups,log2fc,pvalue)
  return(Data_Pr)
